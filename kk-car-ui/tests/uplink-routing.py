...
try:
    ...
    source=source.replace('/etc/kk-car/uplink-policy.uc',b+'/policy.uc').replace('/tmp/kk-car-uplink',b+'/state')
    ...
    source=source.replace("let cell=address(bus,'wan','eth1'), wire=address(bus,'kk_ethwan','eth0'), lan=address(bus,'lan','br-lan');",'let cell=fixture.cell, wire=fixture.wire, lan=fixture.lan;')
