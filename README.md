...
| 电子纸本地控制台 | Waveshare 2.7 英寸 V2 五页、每页 10 项状态；顶栏显示日期时间、页码、电量与充放电方向，首页突出延迟与蜂窝信号；四键负责首页、上下翻页、设置/确认，可运行检查并调整 VPN、Wi-Fi 频段、有线口和刷新周期；高对比度文字、快刷/局刷与灰阶全刷配合，网络设置沿用限时回退 |
