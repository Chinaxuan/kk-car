...
| 电子纸本地控制台 | Waveshare 2.7 英寸 V2 六页按总览、蜂窝、VPN、短信/流量、UPS 电源、系统分类；首页突出 VPN 延迟、蜂窝信号、未查看短信与关键运行数据；四键负责首页、上下翻页、设置/确认，可运行检查并调整 VPN、Wi-Fi 频段、有线口和刷新周期；高对比度文字、快刷/局刷与灰阶全刷配合，网络设置沿用限时回退 |
